...
const GeneralInfo = () => {
    ...
    <Box sx={{
        ...
        <Typography variant='h7' sx={{fontWeight: 545}}>First Name: </Typography>
        <TextField fullWidth variant='outlined' size='small' margin="normal" value={'Prathamesh'} disabled/>

        <Typography variant='h7' sx={{fontWeight: 545}}>Last Name: </Typography>
